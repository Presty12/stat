const { Client, Discord, MessageEmbed, Collection, WebhookClient, MessageAttachment } = require('discord.js');
...
const sayiEmojiler = {
  0: "<a:viana0:785579667699531786>",
  1: "<a:viana1:785579654173032478>",
  2: "<a:viana2:785579620736303125>",
  3: "<a:viana3:785579667570294844>",
  4: "<a:viana4:785579667486277692>",
  5: "<a:viana5:785579667582484490>",
  6: "<a:viana6:785579667444072489>",
  7: "<a:viana7:785579665909612574>",
  8: "<a:viana8:785579667507118162>",
  9: "<a:viana9:785579667704119337>"
};
...
client.on('message', message => {
if(message.content.startsWith('v!oylama')){
const args = message.content.split(' ').slice(1)
const botmesajı = args.join(" ")
if(!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send('Bo Komudu Kullanamazsın!')
if(!botmesajı) return message.channel.send('Lütfen oylamanın ne hakkında olacağını belirtin!');
...
.setColor("RANDOM")
.setFooter('Oylama Başlama Saati')
.setTimestamp()
