...
module.exports.execute = async(client, message, args, ayar, emoji) => {
  	let raw = db.get("raw");
	  let embed = new MessageEmbed().setAuthor(message.author.username, message.author.avatarURL({dynamic:true})).setColor("RANDOM").setFooter("Viana Moderation").setDescription(`Son __14 günlük__ kullanıcı aktiflik verileri.`);
